...
async def chat(request: Request, chat_req: ChatRequest):
    try:
        ...
        vector_store_base = os.path.join(user_artifact_dir, "transformation", "vector_store")
        ...
        result = await pipeline.run_graph(initial_state, config={"configurable": {"thread_id": thread_id}})
